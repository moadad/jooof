  ...
  renderedItems.forEach((product, index) => {
    ...
    card.innerHTML = `
      ...
      <div class="product-body">
        ...
        <h3 class="product-title"><a class="product-title-link" href="${escapeAttr(productPageUrl)}" aria-label="فتح صفحة ${escapeAttr(productLabel)}"></a></h3>
    ...
    card.querySelector('.product-title-link').textContent = product.name || 'بدون اسم';
